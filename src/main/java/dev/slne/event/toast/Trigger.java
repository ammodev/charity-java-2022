...
public class Trigger {
    ...
    public static enum TriggerType {
        ARBITRARY_PLAYER_TICK, BRED_ANIMALS, BREWED_POTION, CHANGED_DIMENSION, CONSTRUCT_BEACON, CONSUME_ITEM,
        CURED_ZOMBIE_VILLAGER, ENCHANTED_ITEM, ENTER_BLOCK, ENTITY_HURT_PLAYER, ENTITY_KILLED_PLAYER, IMPOSSIBLE,
        INVENTORY_CHANGED, ITEM_DURABILITY_CHANGED, LEVITATION, LOCATION, PLACED_BLOCK, PLAYER_HURT_ENTITY,
        PLAYER_KILLED_ENTITY, RECIPE_UNLOCKED, SLEPT_IN_BED, SUMMONED_ENTITY, TAME_ANIMAL, TICK, USED_ENDER_EYE,
        VILLAGER_TRADE
    }
    ...
    public static class TriggerBuilder {
        ...
        public Trigger build() {
            ...
            switch (this.conditions == null ? 0 : this.conditions.size()) {
                ...
                case 1:
                    ...
                    break;
                default:
                    conditions = new java.util.LinkedHashSet<Condition.ConditionBuilder>(
                            this.conditions.size() < 1073741824
                                    ? 1 + this.conditions.size() + (this.conditions.size() - 3) / 3
                                    : Integer.MAX_VALUE);
        ...
        public String toString() {
            return "io.chazza.advancementapi.Trigger.TriggerBuilder(type=" + this.type + ", name=" + this.name
